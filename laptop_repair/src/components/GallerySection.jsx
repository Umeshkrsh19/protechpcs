...
export default function GallerySection() {
  return (
    <section className="py-24 bg-repair-light" id="gallery">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-repair-dark">Our Repair Gallery</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {laptopImages.slice(0, 8).map((image, index) => (
            <div key={index} className={`relative overflow-hidden rounded-lg group ${index === 0 || index === 5 ? 'col-span-2 row-span-2' : 'col-span-1 row-span-1'}`}>
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-repair-dark/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
